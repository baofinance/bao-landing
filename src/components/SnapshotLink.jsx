  ...
  return (
    <div className="mt-10 flex items-center justify-center gap-x-6 align-middle lg:mt-0 lg:flex-shrink-0">
      <Link
        ...
        className="flex space-x-2 rounded-3xl bg-gray-700 px-3.5 py-2.5 text-sm font-semibold text-baoWhite shadow-sm hover:bg-indigo-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
      >
