...
export const BaoQuestionLogo = () => (
  ...
  >
    <circle cx="367.02" cy="367.02" r="360.39" fill="#e23a52" />
    <g fill="none" stroke="#faf2e3" strokeMiterlimit="10" strokeWidth="24">
