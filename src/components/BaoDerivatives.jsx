...
const BaoDerivatives = () => {
  ...
  return (
    <section className={`${styles.derivativesSection} ${backgroundStyles.backgroundContainer}`}>
          ...
          <div
            ...
            style={{
              backgroundColor: `rgba(226, 26, 83, ${
                isAdjacent(index, hoveredIndex, Math.ceil(window.innerWidth / 12)) ? 0 : square.baseOpacity
              })`,
      ...
      <div className={styles.content}>
        ...
        <div className={styles.boxes}>
          <div className={styles.box}>
            ...
            <p className={styles.boxDescription}>Backed by ETH and other ETH backed tokens. A safe haven for those that favor decentralization and transparency.</p>
          </div>
          <div className={styles.box}>
            <div className={styles.logoContainer}>
            ...
            <p className={styles.boxDescription}>Backed by ETH. baoETH solves high borrow rates for ETH. Unlike traditional markets, baoETH does not need to be deposited before it is borrowed unlocking greater capital efficiency for borrowers.</p>
          </div>
          <div className={styles.box}>
            <div className={styles.logoContainer}>
              <svg className={styles.logo} viewBox="0 0 24 24" width="24" height="24">
                <path fill="#faf2e3" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-13h2v6h-2zm0 8h2v2h-2z" />
              </svg>
            </div>
            <h3 className={styles.boxTitle}>Coming Soon</h3>
            <p className={styles.boxDescription}>As long as there is a data feed for the price of the asset, bao will be able to create a derivative for it. Join the discussion on our discord server on which tokens to bring to life next!</p>
          </div>
        </div>
      </div>
    </section>
