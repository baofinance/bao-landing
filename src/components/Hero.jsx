        ...
        <div className="w-full">
          <div className="max-w-2xl lg:max-w-none">
            <div className="flex flex-col space-y-6">
              <p className="text-3xl font-heading leading-tight text-baoWhite lg:text-5xl h-[1.2em] flex items-center">
                {text}
                <span className={`${styles.cursor} ${isTyping ? styles.blinking : ''}`}>|</span>
              </p>
              <p className="font-heading leading-tight text-6xl lg:text-8xl xl:text-9xl text-baoWhite">
              ...
              <div className="flex flex-wrap items-end gap-x-12 gap-y-8">
                ...
                <div className="flex gap-x-6">
                  <Button href="https://info.bao.finance/docs" variant="solid" color="baoPink">Learn More</Button>
                  <Button href="https://app.baofinance.io" variant="solid" color="baoPink">Launch App</Button>
                </div>
              </div>
            </div>
          </div>
